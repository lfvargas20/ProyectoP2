...
public class VehiculoFXMLController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ArrayList<String> nombres = new ArrayList(Arrays.asList("Auto","Camioneta","Moto"));
    ...
    @FXML
        private void cb(ActionEvent event) {
            ...
            if(tipo.equals("Auto")){
                ...
                ArrayList<String> atrib = Camioneta.atributos();
                for(String cad:atrib)
                    if(cad.equals("Año") || cad.equals("Recorrido") || cad.equals("Precio"))
                        añadirCajaNumeros(cad+":", cad);
                    else
    ...
    public Camioneta crearCamioneta() throws MalosDatosException, ObjetoYaRegistradoException{
        ...
        double precio = Double.parseDouble(info.get(5));
        if(año>0 && recorrido>0 && precio>0 && Vehiculo.comprobarRegistro(info.get(0), "vehiculos")){
        return new Camioneta(info.get(0),año,recorrido,info.get(3),info.get(4),precio,info.get(6),info.get(7),info.get(8),info.get(9),info.get(10),info.get(11));
        }else
            if (!Vehiculo.comprobarRegistro(info.get(0), "vehiculos"))
                throw new ObjetoYaRegistradoException("Esa matrícula ya esta tomada");
            else
    ...
    public Moto crearMoto() throws MalosDatosException, ObjetoYaRegistradoException{
        ...
        int año = Integer.parseInt(info.get(1));
        double recorrido = Double.parseDouble(info.get(2));
        double precio = Double.parseDouble(info.get(4));
        //String placa,int año,double recorrido,String color,double precio,
           // String marca, String modelo,String motor, String combustible
       // info.get(0),año,recorrido,info.get(3),info.get(4),precio,info.get(6),info.get(7),info.get(8),info.get(9),info.get(10)
        if(año>0 && recorrido>0 && precio>0 && Vehiculo.comprobarRegistro(info.get(0), "vehiculos")){
        return new Moto(info.get(0),año,recorrido,info.get(3),precio,info.get(5),info.get(6),info.get(7),info.get(8));
        }else
            if (!Vehiculo.comprobarRegistro(info.get(0), "vehiculos"))
                throw new ObjetoYaRegistradoException("Esa matrícula ya esta tomada");
            else
